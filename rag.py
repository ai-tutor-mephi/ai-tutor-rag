...
async def query_endpoint(data: QueryRequest) -> JSONResponse:
    ...
    1. Классификация: общий вопрос по документу или узкий
    2. Перефразирование вопроса на основе истории диалога
    3. Агент: RAG — при общем вопросе сбор всех чанков из Qdrant (scroll); при узком —
       аспекты, векторный поиск, граф Neo4j
