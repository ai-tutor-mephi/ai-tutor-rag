...
- Строковые значения JSON должны быть валидны для парсера JSON: без «сырых» обратных косых черт кроме стандартных escape-последовательностей (\\\\, \\\", \\n, \\uXXXX). Не используй LaTeX вроде \\frac в тексте — математику формулируй словами или символами Unicode.
